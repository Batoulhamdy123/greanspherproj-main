...
import 'package:greanspherproj/features/dashboard/modelus/Component/model/app_models_and_api_service.dart'; // لتمرير Product type
//import 'package:greanspherproj/features/dashboard/modelus/Component/ComponentPage.dart'; // استيراد ComponentPage للوصول إلى الـ static members

class ProfileScreen extends StatelessWidget {
  final String userName;
  // Constructor لا يتطلب أي بارامترات خاصة بالمفضلة الآن
  ProfileScreen({
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          buildMenuItem(
              context, "assets/images/pay.png", "Pay", AddNewCardScreen()),
          buildMenuItem(
            context,
            ...
            FavouriteScreen(
              ...
              onRemoveFavorite:
                  ComponentPageState.handleFavoriteRemovedFromScreenStatic,
              onClearAllFavorites:
                  ComponentPageState.handleClearAllFavoritesFromScreenStatic,
            ),
          ),
